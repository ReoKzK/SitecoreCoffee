...
namespace SitecoreCoffee.Foundation.ORM.Repositories
{
    public interface IContentRepository
    {
        ...
        T GetItem<T>(Guid id, bool isLazy = true, bool inferType = false) where T : class;
        T GetItem<T>(Guid id, Language language, bool isLazy = true, bool inferType = false) where T : class;
